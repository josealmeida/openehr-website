...
<div id="MainFrame">
	...
	<div id="MainArea" style="height:450px;">
		...
		<p> 
		   If three independent* <em>Qualified Members</em> agree to suggest a 
		   new member and presents the candidate (including openEHR related merits), then the <em>Program Committee</em>
		   should discuss and consider if the new member should be a) approved at present or b) be recomended to first 
		   gain more experience in order to get suggested again later. 
		</p> 
		<p>   
		   If thorny vendor/institution-related issues arise that at least three independent* Qualified 
		   Members think would benefit from vendor/institution balance, then the issue can be transferred
		   to the program committiee instead.
		</p> 
		<p>
